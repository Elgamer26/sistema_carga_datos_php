...
<div class="app-main__inner">
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                    Listado de compras herramientas - <a style="color: white;" href="../inventario/crear_comprah.php" class="btn btn-primary "><i class="fa fa-plus"></i> Nuevo registro</a>
                    <div class="page-title-subheading">
                        Lista de compras herramientass disponibles
                    </div>
                </div>
            </div>
    ...
    <div class="form-row text-center">
        <div class="col-lg-12" style="width: 100%;">
            <table id="tabla_compras_herramienta" class="mb-0 table table-striped" style="width: 100%;">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Acción</th>
