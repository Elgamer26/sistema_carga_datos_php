...
<div class="app-main__inner">
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                    Nueva compra herramienta
                    <div class="page-title-subheading">
                        Crear una nueva compra herramienta.
                    </div>
                </div>
            </div>
            <div class="page-title-actions">
                <label class="form-label">Nueva compra herramienta</label>
                <div class="d-inline-block dropdown">
                    <a href="../inventario/list_comprah.php"> / Listado </a>
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            <h5 class="card-title">Nueva compra herramienta.</h5>
            ...
            <div class="form-row text-center">
                ...
                <div class="col-md-1 mb-3">
                    <label>...</label>
                    <button onclick="modal_herramienta();" class="btn btn-warning"><i class="fa fa-eye"></i> <b>Buscar...</b> </button>
                </div>

                <div class="row">

                    <input type="text" hidden id="id_herramienta_t">

                    <div class="col-md-6 mb-3">
                        <label for="herramienta_t">Herramienta</label> <b><label style="color: red;" id="herramienta_t_obligg"></label></b>
                        <input disabled type="text" class="form-control" id="herramienta_t" />
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="col-md-12 mb-4">
                            <h4 class="bg bg-info" style="border-radius: 20px; color: black;"><b> Detalle de compra herramienta</b></h4>
                        </div>
                        <table id="detalle_compra_herramienta" class="table table-striped table-bordered">
                            ...
                            <tbody id="tbody_detalle_compra_herramienta">
                            </tbody>
                        </table>
                ...
                <div class="col-md-12 p-1">
                    <button onclick="registra_compra_herramienta();" class="btn btn-primary">
                        <i class="fa fa-save"></i> Registrar
                    </button> -
                    <a href="../inventario/list_comprah.php" class="btn btn-danger">Volver</a>
                </div>
...
<div class="modal" id="modal_productos_herramienta">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal_eitar_rolLabel">Herramienta disponibles</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-row text-center">
                    <div class="col-lg-12" style="width: 100%;">
                        <table id="herramienta_disponibles" class="table table-striped text-center" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Acción</th>
...
<script>
    ...
    function ingresar_detalle() {
        var id = $("#id_herramienta_t").val();
        var herramienta = $("#herramienta_t").val();
        ...
        if (id.length == 0 || herramienta.length == 0 || precio.length == 0) {
            $("#herramienta_t_obligg").html(" - Ingrese herramienta");

            return swal.fire(
                "Campos vacios",
                "Debe ingresar el herramienta",
                "warning"
            );
        } else {
            $("#herramienta_t_obligg").html("");
        }
        ...
        if (verificar_herramienta_id(id)) {
            return Swal.fire(
                "Mensaje de advertencia",
                "La herramienta '" +
                herramienta + "', ya fue agregado al detalle",
                "warning"
            );
        }
        ...
        "</td>";
        datos_agg +=
            "<td><button onclick='remove_herramienta_detalle(this)' class='btn btn-danger'><i class='fa fa-trash'></i></button></td>";
        datos_agg += "</tr>";

        $("#tbody_detalle_compra_herramienta").append(datos_agg);

        sumartotalneto();
        $("#id_herramienta_t").val("");
        $("#herramienta_t").val("");
        $("#precio_compra_t").val("");
        $("#cantidad_t").val("0");
        $("#descuento_t").val("0");
    ...
    function remove_herramienta_detalle(t) {
        var td = t.parentNode;
    ...
    function verificar_herramienta_id(id) {
        let idverificar = document.querySelectorAll(
            "#tbody_detalle_compra_herramienta td[for='id']"
        );
