...
<div class="app-main__inner">
            ...
            <div class="page-title-heading">
                ...
                <div>
                    ...
                    <div class="page-title-subheading">
                        Crear un Proceso de cajas.
                    </div>
                </div>
            </div>
            <div class="page-title-actions">
                <label class="form-label">Proceso de cajas</label>
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            <h5 class="card-title">Proceso de cajas.</h5>
            ...
            <div class="form-row text-center">
                ...
                <div class="col-md-12">
                    <button onclick="subir_excel();" class="btn btn-primary">
                        <i class="fa fa-save"></i> Subir archivo
                    </button>
                    -
                    <a href="../manejo_datos/proceso_cajas.php" class="btn btn-danger">Recargar</a>
                </div>
            ...
            <div class="form-row text-center" id="unir_exel_cajas">
