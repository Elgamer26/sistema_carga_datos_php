...
<div class="app-main__inner">
            ...
            <div class="page-title-heading">
                ...
                <div>
                    ...
                    <div class="page-title-subheading">
                        Crear un Proceso de recobro.
                    </div>
                </div>
            </div>
            <div class="page-title-actions">
                <label class="form-label">Proceso de recobro</label>
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            <h5 class="card-title">Proceso de recobro.</h5>
            ...
            <div class="form-row text-center">
                ...
                <div class="col-md-12">
                    <button onclick="subir_excel_recobro();" class="btn btn-primary">
                        <i class="fa fa-save"></i> Subir archivo
                    </button>
                    -
                    <a href="../manejo_datos/proceso_recobro.php" class="btn btn-danger">Recargar</a>
                </div>
            ...
            <div class="form-row text-center" id="unir_exel_recobro">
