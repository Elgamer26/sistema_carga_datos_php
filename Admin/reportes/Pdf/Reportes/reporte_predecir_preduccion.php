...
$html = '<!DOCTYPE html>
    <html lang="en">
      <head>
        <meta charset="utf-8">
        <title>Informe predicción producción</title>
      ...
      <body>  
            ...
            <table style="border-collapse;" border="1">
                <thead>
                        <tr>
                            ...
                            <h1  style="color: black;"> Producción </h1>
                            <h6 style="color: black;">Predicción producción: <span style="color: black;"></span> ' . $valor . '  </span> </h6> 
                            </th>
                        </tr>
                </thead>
            </table>
        ...
        <main>
          <table>
            <thead>
              <tr>
                <th style="color: black;" style="text-align: center;">Predicción de producción "' . $valor . '"</th> 
              </tr>
            </thead>
            <tbody>';

$html .= '<tr>
                <td class="desc" style="text-align: center;">  <img src="img/producción_' . $valor . '_' . $tipo . '.jpg" alt="producción" />   </td> 
              </tr>';
