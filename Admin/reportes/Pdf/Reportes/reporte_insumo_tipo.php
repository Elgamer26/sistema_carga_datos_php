...
$html = '<!DOCTYPE html>
    <html lang="en">
      <head>
        <meta charset="utf-8">
        <title>Informe de insumos por tipo</title>
            ...
            <table style="border-collapse;" border="1">
                <thead>
                        <tr>
                            ...
                            <h1  style="color: black;"> Insumos </h1>
...
$sqldetalle = 'SELECT
            ...
            FROM
            tipo_insumo
            INNER JOIN insumo ON tipo_insumo.id = insumo.tipo 
            WHERE
            insumo.estado = 1 
            AND insumo.eliminado = 1 
            AND insumo.tipo = "' . $_GET["id"] . '"';
