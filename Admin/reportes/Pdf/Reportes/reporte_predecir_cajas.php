...
$html = '<!DOCTYPE html>
    <html lang="en">
      <head>
        <meta charset="utf-8">
        <title>Informe predicción cajas</title>
      ...
      <body>  
            ...
            <table style="border-collapse;" border="1">
                <thead>
                        <tr>
                            ...
                            <h6 style="color: black;">Predicción cajas: <span style="color: black;"></span> ' . $valor . '  </span> </h6> 
                            </th>
                        </tr>
                </thead>
            </table>
        ...
        <main>
          <table>
            <thead>
              <tr>
                <th style="color: black;" style="text-align: center;">Predicción de cajas "' . $valor . '"</th> 
              </tr>
            </thead>
            <tbody>';

$html .= '<tr>
                <td class="desc" style="text-align: center;">  <img src="img/cajas_' . $valor . '_' . $tipo . '.jpg" alt="cajas" />   </td> 
              </tr>';
