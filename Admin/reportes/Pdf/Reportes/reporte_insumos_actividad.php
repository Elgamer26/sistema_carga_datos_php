...
$html = '<!DOCTYPE html>
    <html lang="en">
      <head>
        <meta charset="utf-8">
        <title>Informe de insumo en actividad</title>
            ...
            <table style="border-collapse;" border="1">
                <thead>
                        <tr>
                            ...
                            <h1  style="color: black;"> Insumo en actividad </h1>
...
$sqldetalle = 'SELECT
    ...
    FROM
        ...
        INNER JOIN produccion_insumo ON produccion.id = produccion_insumo.produccion_id
...
while ($rowmedi = $resultmedi->fetch_assoc()) {
    ...
    $html .= '<tr>
                ...
                <td class="desc"> ' . $rowmedi['insumo'] . ' </td> 
                <td class="desc"> ' . $rowmedi['tipo_insumo'] . ' </td>
