...
$html = '<!DOCTYPE html>
    <html lang="en">
      <head>
        <meta charset="utf-8">
        <title>Informe predicción cintas</title>
      ...
      <body>  
            ...
            <table style="border-collapse;" border="1">
                <thead>
                        <tr>
                            ...
                            <h1  style="color: black;"> Recobro cintas </h1>
                            <h6 style="color: black;">Predicción cintas: <span style="color: black;"></span> ' . $valor . '  </span> </h6> 
                            </th>
                        </tr>
                </thead>
            </table>
        ...
        <main>
          <table>
            <thead>
              <tr>
                <th style="color: black;" style="text-align: center;">Predicción de cintas "' . $valor . '"</th> 
              </tr>
            </thead>
            <tbody>';

$html .= '<tr>
                <td class="desc" style="text-align: center;">  <img src="img/cintas_' . $valor . '_' . $tipo . '.jpg" alt="cintas" />   </td> 
              </tr>';
